...
export class OidcSecurityValidation {
    ...
    public GetTokenExpirationDate(token: string) {
        let decoded = this.GetPayloadFromToken(token, false);
        let tokenExpirationDate = this._getTokenExpirationDate(decoded);
    ...
    private _getTokenExpirationDate(dataIdToken: any): Date {
